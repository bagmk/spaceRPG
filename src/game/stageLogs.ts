...
export const STAGE_LOGS: StageLog[] = [
  ...
  { stageId: 1, progress: 3,   title: { en: 'A Tiny Universe',        ko: '아주 작은 우주' },         message: { en: 'Everything visible is still packed into a microscopic state.', ko: '보이는 모든 것이 아직 미시적인 상태에 압축되어 있습니다.' } },
  { stageId: 1, progress: 8,  title: { en: 'Expansion Surge',        ko: '팽창 가속' },              message: { en: 'Distances stretch before matter has time to organize.', ko: '물질이 정리할 시간을 갖기도 전에 거리가 늘어납니다.' } },
  { stageId: 1, progress: 18,  title: { en: 'Quantum Seeds',          ko: '양자 씨앗' },              message: { en: 'Tiny fluctuations are stretched into the first hints of cosmic structure.', ko: '작은 요동이 늘어나 최초의 우주 구조의 단서가 됩니다.' } },
  { stageId: 1, progress: 35,  title: { en: 'Cooling Begins',         ko: '냉각 시작' },              message: { en: 'The young universe expands, thins, and starts to cool.', ko: '어린 우주는 팽창하고 옅어지며 식기 시작합니다.' } },
  { stageId: 1, progress: 60,  title: { en: 'Inflation Settles',      ko: '인플레이션 안정' },        message: { en: 'The violent expansion slows into a universe ready to evolve.', ko: '격렬한 팽창이 진화할 준비가 된 우주로 가라앉습니다.' } },
  ...
  { stageId: 2, progress: 3,   title: { en: 'Symmetry Holds',         ko: '대칭 유지' },              message: { en: 'For every particle, an opposite partner appears.', ko: '모든 입자에 대해 반대 짝이 나타납니다.' } },
  { stageId: 2, progress: 8,  title: { en: 'Annihilation',           ko: '쌍소멸' },                 message: { en: 'Matter and antimatter collide, turning mass back into radiation.', ko: '물질과 반물질이 충돌하며 질량이 다시 복사로 돌아갑니다.' } },
  { stageId: 2, progress: 18,  title: { en: 'A Small Imbalance',      ko: '작은 불균형' },            message: { en: 'A tiny excess of matter survives the annihilation.', ko: '쌍소멸 속에서 아주 미세한 물질의 잉여가 살아남습니다.' } },
  { stageId: 2, progress: 35,  title: { en: 'Matter Remains',         ko: '물질이 남다' },            message: { en: 'Almost everything vanished, but the leftover matter will become everything we know.', ko: '거의 모든 것이 사라졌지만, 남은 물질이 우리가 아는 모든 것이 될 것입니다.' } },
  { stageId: 2, progress: 60,  title: { en: 'The Bias Is Set',        ko: '편향 확정' },              message: { en: 'The universe now has enough matter to build future structure.', ko: '우주는 이제 미래 구조를 만들기에 충분한 물질을 갖습니다.' } },
  ...
  { stageId: 3, progress: 3,  title: { en: 'Free Quarks',            ko: '자유 쿼크' },              message: { en: 'Quarks and gluons move through an extremely hot, dense plasma.', ko: '쿼크와 글루온이 매우 뜨겁고 밀도 높은 플라스마 속을 움직입니다.' } },
  { stageId: 3, progress: 8,  title: { en: 'No Atoms Yet',           ko: '아직 원자는 없음' },       message: { en: 'Matter exists, but it is still too energetic to form stable structures.', ko: '물질은 존재하지만, 안정된 구조를 만들기에는 너무 활기찹니다.' } },
  { stageId: 3, progress: 18,  title: { en: 'Cooling Plasma',         ko: '식어가는 플라스마' },      message: { en: 'Expansion lowers the temperature enough for particles to begin pairing.', ko: '팽창으로 온도가 낮아져 입자가 짝을 이루기 시작합니다.' } },
  { stageId: 3, progress: 35,  title: { en: 'Confinement Nears',      ko: '가둠 임박' },              message: { en: 'Quarks begin losing their freedom as the universe cools.', ko: '우주가 식으면서 쿼크가 자유를 잃기 시작합니다.' } },
  { stageId: 3, progress: 60,  title: { en: 'Hadron Formation',       ko: '강입자 형성' },            message: { en: 'The first stable protons and neutrons are about to appear.', ko: '최초의 안정된 양성자와 중성자가 등장하려 합니다.' } },
  ...
  { stageId: 4, progress: 3,  title: { en: 'Hydrogen Dominates',     ko: '수소가 지배' },            message: { en: 'Simple hydrogen nuclei fill most of the young universe.', ko: '단순한 수소 원자핵이 어린 우주의 대부분을 채웁니다.' } },
  { stageId: 4, progress: 8,  title: { en: 'Helium Forms',           ko: '헬륨 생성' },              message: { en: 'Some particles fuse into helium, the second great ingredient of stars.', ko: '일부 입자가 융합되어 별의 두 번째 주요 성분인 헬륨이 됩니다.' } },
  { stageId: 4, progress: 18,  title: { en: 'Light Elements',         ko: '가벼운 원소' },            message: { en: 'A small amount of deuterium, helium, and lithium joins the mix.', ko: '소량의 중수소, 헬륨, 리튬이 혼합물에 합류합니다.' } },
  { stageId: 4, progress: 35,  title: { en: 'Fusion Window Closing',  ko: '핵융합 창이 닫힘' },       message: { en: 'The universe cools too quickly for heavier elements to form here.', ko: '우주가 너무 빨리 식어 무거운 원소가 여기서 만들어지지 못합니다.' } },
  { stageId: 4, progress: 60,  title: { en: 'Primordial Recipe',      ko: '원시 레시피' },            message: { en: 'The early chemical inventory is nearly fixed.', ko: '초기 화학 목록이 거의 확정됩니다.' } },
  ...
  { stageId: 5, progress: 3,  title: { en: 'Electrons Slow',         ko: '전자 감속' },              message: { en: 'Cooling allows electrons to approach atomic nuclei.', ko: '냉각으로 전자가 원자핵에 접근할 수 있게 됩니다.' } },
  { stageId: 5, progress: 8,  title: { en: 'Atoms Form',             ko: '원자 형성' },              message: { en: 'Electrons bind to nuclei, creating the first neutral atoms.', ko: '전자가 핵과 결합하여 최초의 중성 원자를 만듭니다.' } },
  { stageId: 5, progress: 18,  title: { en: 'Light Escapes',          ko: '빛의 탈출' },              message: { en: 'Photons can finally travel freely across space.', ko: '광자가 마침내 공간을 자유롭게 가로지를 수 있습니다.' } },
  { stageId: 5, progress: 35,  title: { en: 'The Universe Clears',    ko: '우주가 맑아짐' },          message: { en: 'The cosmic fog fades into a faint background glow.', ko: '우주 안개가 희미한 배경 빛으로 사라집니다.' } },
  { stageId: 5, progress: 60,  title: { en: 'Afterglow',              ko: '잔광' },                   message: { en: 'The released light becomes the oldest visible signal in the universe.', ko: '풀려난 빛이 우주에서 가장 오래된 가시 신호가 됩니다.' } },
  ...
  { stageId: 6, progress: 3,  title: { en: 'No Stars Yet',           ko: '아직 별은 없음' },         message: { en: 'Hydrogen and helium drift through space without a source of light.', ko: '수소와 헬륨이 빛의 원천 없이 공간을 떠돕니다.' } },
  { stageId: 6, progress: 8,  title: { en: 'Gravity Begins Its Work',ko: '중력이 일하기 시작' },     message: { en: 'Tiny density differences slowly pull gas into darker regions.', ko: '작은 밀도 차이가 천천히 기체를 더 어두운 영역으로 끌어당깁니다.' } },
  { stageId: 6, progress: 18,  title: { en: 'Clouds Gather',          ko: '구름이 모임' },            message: { en: 'Invisible halos and gas clouds begin shaping the future cosmic web.', ko: '보이지 않는 헤일로와 기체 구름이 미래 우주 거미줄을 빚기 시작합니다.' } },
  { stageId: 6, progress: 35,  title: { en: 'Collapse Deepens',       ko: '붕괴 심화' },              message: { en: 'The densest clouds grow heavy enough to prepare for ignition.', ko: '가장 밀도 높은 구름이 점화를 준비할 만큼 무거워집니다.' } },
  { stageId: 6, progress: 60,  title: { en: 'First Cores',            ko: '최초의 핵' },              message: { en: 'The first star-forming cores begin to warm inside the darkness.', ko: '최초의 별 형성 핵이 어둠 속에서 데워지기 시작합니다.' } },
  ...
  { stageId: 7, progress: 3,  title: { en: 'Dense Primordial Clouds',ko: '밀집 원시 구름' },         message: { en: 'Hydrogen gathers into massive, unstable clouds.', ko: '수소가 거대하고 불안정한 구름으로 모입니다.' } },
  { stageId: 7, progress: 8,  title: { en: 'Ignition',               ko: '점화' },                   message: { en: 'The first stars ignite, ending millions of years of darkness.', ko: '최초의 별이 점화되어 수백만 년의 어둠을 끝냅니다.' } },
  { stageId: 7, progress: 18,  title: { en: 'Massive and Brief',      ko: '거대하고 짧은 생애' },     message: { en: 'These early stars burn intensely and live fast.', ko: '이 초기 별들은 격렬하게 타오르며 빠르게 살아갑니다.' } },
  { stageId: 7, progress: 35,  title: { en: 'First Heavy Elements',   ko: '최초의 무거운 원소' },     message: { en: 'Inside the first stars, heavier elements begin to form.', ko: '최초의 별 내부에서 무거운 원소가 만들어지기 시작합니다.' } },
  { stageId: 7, progress: 60,  title: { en: 'Radiation Fronts',       ko: '복사 전선' },              message: { en: 'Starlight pushes into the surrounding gas.', ko: '별빛이 주변 기체로 밀고 들어갑니다.' } },
  ...
  { stageId: 8, progress: 3,  title: { en: 'Ionized Bubbles',        ko: '이온화 거품' },            message: { en: 'Light carves glowing bubbles around the first stars.', ko: '빛이 첫 별 주위에 빛나는 거품을 새깁니다.' } },
  { stageId: 8, progress: 8,  title: { en: 'Growing Cavities',       ko: '성장하는 공동' },          message: { en: 'Ionized regions expand into the neutral hydrogen fog.', ko: '이온화된 영역이 중성 수소 안개로 확장됩니다.' } },
  { stageId: 8, progress: 18,  title: { en: 'Bubbles Overlap',        ko: '거품의 중첩' },            message: { en: 'Separate regions of light begin connecting across space.', ko: '분리된 빛의 영역이 공간을 가로질러 연결되기 시작합니다.' } },
  { stageId: 8, progress: 35,  title: { en: 'The Fog Breaks',         ko: '안개가 걷힘' },            message: { en: 'The universe becomes increasingly transparent to ultraviolet light.', ko: '우주가 자외선에 점점 더 투명해집니다.' } },
  { stageId: 8, progress: 60,  title: { en: 'Cosmic Web Revealed',    ko: '우주 거미줄 드러남' },     message: { en: 'The large-scale structure of the universe becomes easier to see.', ko: '우주의 거대 구조가 보기 쉬워집니다.' } },
  ...
  { stageId: 9, progress: 3,  title: { en: 'Proto-Galaxies',         ko: '원시 은하' },              message: { en: 'Small stellar groups merge into larger structures.', ko: '작은 항성 집단이 더 큰 구조로 병합됩니다.' } },
  { stageId: 9, progress: 8,  title: { en: 'Galactic Cores',         ko: '은하 핵' },                message: { en: 'Dense centers form as matter falls inward.', ko: '물질이 안쪽으로 떨어지면서 밀집된 중심이 형성됩니다.' } },
  { stageId: 9, progress: 18,  title: { en: 'Arms and Halos',         ko: '나선팔과 헤일로' },        message: { en: 'Rotation and gravity sculpt disks, arms, and halos.', ko: '회전과 중력이 원반, 나선팔, 헤일로를 조각합니다.' } },
  { stageId: 9, progress: 35,  title: { en: 'Cosmic Cities',          ko: '우주 도시' },              message: { en: 'Galaxies become the major homes of stars, gas, and future planets.', ko: '은하가 별, 기체, 미래 행성의 주요 거처가 됩니다.' } },
  { stageId: 9, progress: 60,  title: { en: 'A Local Neighborhood',   ko: '지역 이웃' },              message: { en: 'One galaxy becomes the stage for a future solar system.', ko: '한 은하가 미래 태양계의 무대가 됩니다.' } },
