...
export const STAGE_ENTITIES: StageEntity[] = [
  ...
  ...stage(2, [
    ...
    item('Neutrino',            'ν',   'Nearly massless lepton crossing matter undisturbed.',     'common', 'auto_mult',  5.0),
  ...
  ...stage(9, [
    ...
    item('Dark Matter Halo',      '○',  'Massive dark scaffold shaping the galactic potential.',   'rare', 'auto_mult', 3.0),
