...
export const STAGE_ENTITIES: StageEntity[] = [
  ...
  ...stage(4, [
    ...
    item('Deuterium',            'D',   'Hydrogen-2, the first stable bridge in fusion chains.',  'common', 'time', 1.5),
    item('Gamma Ray',            'γ',   'High-energy photon released by each fusion step.',       'common', 'crit', 0.4, true),
  ...
  ...stage(5, [
    ...
    item('Helium Atom',               'He',   'Helium nucleus pulls in both electrons.',              'common', 'time', 2.0),
    ...
    item('Baryon Acoustic Oscillation','◌',   'Frozen sound waves seeding all large structure.',      'rare', 'time', 2.0),
    ...
    item('Last Scattering Surface',   '═',    'Shell from which CMB photons last scattered.',         'epic', 'time', 4.0),
  ...
  ...stage(6, [
    ...
    item('Dark Matter Filament',  '╌',    'Invisible scaffold along which gas slowly flows.',       'common', 'time', 2.0),
    ...
    item('Dark Matter Clump',     '●',    'Dense dark knot deepening the local gravity well.',      'rare', 'time', 3.0),
  ...
  ...stage(7, [
    ...
    item('Stellar Feedback',    '⟲',   'Energy from stars reshaping the surrounding gas cloud.',  'epic', 'time', 4.0),
  ...
  ...stage(8, [
    ...
    item('Ionization Front',   '→→→',  'Boundary advancing through neutral gas like wildfire.',   'rare', 'time', 3.0),
  ...
  ...stage(9, [
    ...
    item('Dark Matter Halo',      '○',  'Massive dark scaffold shaping the galactic potential.',   'rare', 'time', 3.0),
    ...
    item('Filamentary Structure', '⌇',  'Thread of dark matter and gas connecting galaxy nodes.',  'epic', 'time', 5.0),
  ...
  ...stage(10, [
    ...
    item('Liquid Water',     'H₂O·', 'Stable surface solvent enabling complex chemistry.',       'epic', 'time', 5.0),
  ...
  ...stage(11, [
    ...
    withAliases(
      item('First Ocean',      'H₂O',   'Steam condenses into vast oceans covering the young Earth.', 'common', 'time', 2.0),
      ['s11_02_first_ocean'],
    ),
  ...
  ...stage(12, [
    ...
    item('Carbon-O Core',      'C/O',  'Compact carbon-oxygen core left by spent fusion.',        'common', 'time', 2.0),
    ...
    item('Magnetar',           '⊛M',  'Neutron star with the strongest magnetic fields known.',  'epic', 'time', 5.0),
  ...
  ...stage(14, [
    ...
    item('GW Echo',                   '◌·',  'Faint gravitational-wave memory of ancient mergers.',    'rare', 'time', 3.0),
  ...
  ...stage(15, [
    ...
    item('Information Paradox',    '?⚫',  'Does information survive the final evaporation?',        'epic', 'time', 6.0),
  ...
  ...stage(16, [
    ...
    item('De Sitter Vacuum',         'Λ∞',   'Dark-energy space persists as all matter fades away.',  'epic', 'time', 3.0),
