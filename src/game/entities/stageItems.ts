...
export const STAGE_ENTITIES: StageEntity[] = [
  ...
  ...stage(1, [
    ...
    item('False Vacuum Bubble', '⊙',   'Unstable vacuum pocket releasing its pent-up energy.',   'common', 'click', 1.0),
  ...
  ...stage(3, [
    ...
    item('Gluon Plasma',       'gg',   'Dense bath of unbound color-force carriers.',             'common', 'click', 1.2),
    ...
    item('Charm Quark',        'c',    'Heavy second-generation quark in the plasma.',            'rare',   'click', 2.5),
    ...
    item('Top Quark Decay',    't→',   'Heaviest quark — vanishes almost the instant it forms.', 'epic',   'click', 4.0),
  ...
  ...stage(4, [
    ...
    item('Helium-3',             '³He', 'Light helium isotope in the proton-proton chain.',       'rare',   'click', 2.0),
  ...
  ...stage(5, [
    ...
    item('Photon Decoupling',         'γ↗',   'Light separates from matter and streams freely.',      'rare',   'click', 3.0),
  ...
  ...stage(6, [
    ...
    item('Protogalactic Cloud',   '○',    'Large gas reservoir on its way to becoming a galaxy.',  'rare',   'click', 4.0),
  ...
  ...stage(7, [
    ...
    item('First Heavy Elements','Fe',   'Stellar cores forge elements beyond helium up to iron.', 'epic',   'click', 6.0),
    ...
    item('Pair Instability SN', '✸',   'Giant star destroyed entirely by gamma-pair creation.',   'legendary','multiplier',12.0),
  ]),
  ...
  ...stage(8, [
    ...
    item('Early Galaxy',       '🌀',   'Young galaxy pouring out a torrent of ionizing light.',  'rare',   'click', 4.0),
    ...
    item('Bubble Merger',      '◎',    'Adjacent ionized regions merge into a transparent ocean.','epic',   'click', 6.0),
  ...
  ...stage(9, [
    ...
    item('Galaxy Merger',         '⊗',  'Colliding galaxies stirring gas and triggering starbursts.','rare', 'click', 4.0),
  ...
  ...stage(10, [
    ...
    item('Comet',            '☄',    'Icy body delivering volatiles and organics inward.',       'rare',   'click', 3.0),
    ...
    item('Liquid Water',     'H₂O·', 'Stable surface solvent enabling complex chemistry.',       'epic',   'click', 6.0),
  ...
  ...stage(11, [
    ...
    item('Photosynthesis',    '☀→O₂', 'Light-driven chemistry releasing oxygen into the air.',  'rare',   'click', 4.0),
    ...
    withAliases(
      item('Artificial Satellite','🛰',  'First machines orbit Earth and map the living planet.',  'epic',   'click', 6.0),
      ['s11_10_fish'],
    ),
    ...
    withAliases(
      item('Homo Sapiens',       '🧬',   'A species that turns biology into culture and machines.', 'legendary','multiplier',20.0),
      ['s11_13_intelligence'],
    ),
    withAliases(
      item('Space Telescope',    '🔭',   'A clear eye above the atmosphere looking back in time.', 'legendary','multiplier',18.0),
      ['s11_14_homo_sapiens'],
    ),
  ]),
  ...
  ...stage(12, [
    ...
    item('Mass Transfer',      '→→',   'Binary companion steadily feeding the stellar remnant.',  'rare',   'click', 4.0),
    ...
    item('Nova Eruption',      'NOVA', 'Accreted hydrogen flash on a white dwarf surface.',       'epic',   'click', 6.0),
  ...
  ...stage(13, [
    ...
    item('Cold Gas Remnant',     '~H',  'Unused interstellar gas as star formation winds down.',  'common', 'click', 2.0),
    ...
    item('Gravitational Slingshot','↗', 'Close encounter launching stars out of their galaxy.',   'rare',   'click', 4.0),
    ...
    item('Binary BH Merger',     '⚫⚫','Two black holes spiraling together — ringing spacetime.', 'epic',   'click', 7.0),
  ...
  ...stage(14, [
    ...
    item('GW Echo',                   '◌·',  'Faint gravitational-wave memory of ancient mergers.',    'rare',   'click', 3.0),
    ...
    item('Positronium Atom',          'Ps',  'Electron and positron briefly orbiting each other.',     'epic',   'click', 6.0),
    ...
    item('Baryon Washout',            'B=0', 'Baryon number dwindles to zero across the cosmos.',      'legendary','multiplier',18.0),
  ]),
  ...
  ...stage(15, [
    ...
    item('BH Merger Wave',         '⚫+⚫', 'Black hole inspiral shaking the last geometry.',        'rare',   'click', 5.0),
    ...
    item('Firewall',               '🔥EH', 'High-energy barrier hypothesis at the event horizon.',   'epic',   'click', 7.0),
  ...
  ...stage(16, [
    ...
    item('Thermal Equilibrium',      'ΔT→0', 'Temperature differences vanish everywhere at once.',    'rare',   'click', 4.0),
    ...
    item('Thermal Death',            'ΔS=0', 'Maximum entropy reached; no process can ever run.',     'legendary','multiplier',15.0, false, 'heat_death'),
    item('Dark Energy Spike',        'Λ↑',   'Accelerating expansion tears apart every structure.',   'legendary','multiplier',20.0, false, 'big_rip'),
    item('Gravitational Singularity','ρ→∞',  'All density returns toward a single point.',            'legendary','multiplier',25.0, false, 'big_crunch'),
