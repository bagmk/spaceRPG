...
export const STRINGS = {
  ...
  settingsSaveSection: { en: 'Save Data', ko: '저장 데이터' },
  settingsExport:      { en: 'Export Save', ko: '내보내기' },
  settingsExportHint:  { en: 'Copy or download this code to back up your progress.', ko: '이 코드를 복사하거나 내려받아 진행 상황을 백업하세요.' },
  settingsCopy:        { en: 'Copy', ko: '복사' },
  settingsCopied:      { en: 'Copied!', ko: '복사됨!' },
  settingsDownload:    { en: 'Download', ko: '내려받기' },
  settingsImport:      { en: 'Import Save', ko: '불러오기' },
  settingsImportHint:  { en: 'Paste a save code or upload a file. This replaces your current progress.', ko: '저장 코드를 붙여넣거나 파일을 올리세요. 현재 진행 상황을 덮어씁니다.' },
  settingsImportApply: { en: 'Load Save', ko: '적용' },
  settingsImportFile:  { en: 'Upload File', ko: '파일 선택' },
  settingsImportOk:    { en: 'Save loaded.', ko: '저장을 불러왔습니다.' },
  settingsImportBad:   { en: 'Invalid or corrupt save code.', ko: '잘못되었거나 손상된 저장 코드입니다.' },
  settingsBackups:     { en: 'Recent Backups', ko: '최근 백업' },
  settingsBackupsHint: { en: 'Auto-saved snapshots you can roll back to.', ko: '되돌릴 수 있는 자동 저장 스냅샷입니다.' },
  settingsRestore:     { en: 'Restore', ko: '복원' },
  settingsBackupsEmpty:{ en: 'No backups yet.', ko: '아직 백업이 없습니다.' },
