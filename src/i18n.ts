...
export const STRINGS = {
  ...
  fuseTitle:      { en: 'Promotion Altar', ko: '승급 제단' },
  // ── OVERHAUL5 crew (승급 제단 + 로스터 + 합류 대사) ──
  promoteHint:    { en: 'Feed era cards + stones to promote a crew member — a fail never destroys them', ko: '시대 카드와 강화석으로 크루를 승급하세요 — 실패해도 크루는 사라지지 않습니다' },
  promotePick:    { en: 'Pick a crew member below to promote', ko: '아래에서 승급할 크루를 선택하세요' },
  promoteBtn:     { en: 'Promote', ko: '승급' },
