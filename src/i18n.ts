...
export const STRINGS = {
  ...
  tutTimeGauge:         { en: 'This is Time. It rises by itself, and Time-type entities in the lab can upgrade how fast it fills.',
                          ko: '이것이 시간입니다. 시간은 스스로 오르고, 연구소의 시간형 엔티티로 차오르는 속도를 업그레이드할 수 있습니다.' },
