...
export const STRINGS = {
  ...
  tutFirstFuseEquip:    { en: 'You forged a click booster! Equip it to power up your tapping.',
                          ko: '클릭 강화 아이템을 제련했어요! 장착하면 클릭 파워가 오릅니다.' },
  tutSecondFuseEquip:   { en: 'This one boosts auto income — Matter rises on its own while you are away. Equip it, then collect and enhance items to push it further!',
