...
export const STRINGS = {
  ...
  fuseTitle:      { en: 'Evolution Altar', ko: '진화 제단' },
  evolveLockedUntil: { en: 'Reach Stage {n} to unlock this evolution', ko: 'S{n} 시대에 도달하면 진화할 수 있어요' },
  // ── OVERHAUL5 crew (승급 제단 + 로스터 + 합류 대사) ──
  promoteHint:    { en: 'Feed era cards + stones to EVOLVE a crew member into their next form — a fail never harms them', ko: '시대 카드와 강화석으로 크루를 다음 형태로 진화시키세요 — 실패해도 크루는 다치지 않습니다' },
  promotePick:    { en: 'Pick a crew member below to evolve', ko: '아래에서 진화시킬 크루를 선택하세요' },
  promoteBtn:     { en: 'Evolve', ko: '진화' },
  promoteCards:   { en: 'Cards {have}/{need} (era S{a}–S{b})', ko: '카드 {have}/{need} (시대 S{a}–S{b})' },
  promoteChance:  { en: 'Success {pct}%', ko: '성공 {pct}%' },
  promotePity:    { en: 'Mythic pity {n}/{max} — the floor guarantees it', ko: '신화 천장 {n}/{max} — 가득 차면 확정 성공' },
  promotePityHit: { en: 'PITY!', ko: '천장 발동!' },
  promoteSuccess: { en: 'EVOLVED!', ko: '진화!' },
  promoteFail:    { en: 'Failed — cards spent, half the stones returned, crew unharmed', ko: '실패 — 카드는 소모, 강화석 절반 환급, 크루는 무사합니다' },
  promoteCapped:  { en: 'FINAL FORM', ko: '최종 형태' },
  crewJoinTitle:  { en: 'New crew joined!', ko: '새 크루 합류!' },
  crewLockedJoin: { en: 'Joins at S{n}', ko: 'S{n} 합류' },
  crewTapToMeet:  { en: 'tap to greet', ko: '탭해서 인사' },
  ...
  helpEquipRule2: { en: 'Complete a line of 3 for a multiplier — and the MORE lines you complete at once, the bigger the board bonus.',
                    ko: '한 줄(3칸)을 완성하면 배수 보너스 — 한 번에 더 많은 줄을 완성할수록 보드 보너스가 더 커집니다.' },
  ...
  helpFuseRule3:  { en: 'Mass Fusion fuses every available same-rarity trio at once; ★-favorited items are kept out.',
                    ko: '대규모 융합 — 가능한 같은 등급 3개 묶음을 한 번에 융합합니다. ★로 즐겨찾기한 아이템은 제외됩니다.' },
  helpFuseRule4:  { en: 'Mythic-tier gear comes only from fusing legendaries (Stage 12+). A pity floor guarantees a Mythic after enough unlucky legendary fuses.',
                    ko: '신화 등급 장비는 전설 등급 융합(12스테이지+)으로만 나옵니다. 운이 없어도 전설 융합이 일정 횟수 쌓이면 신화가 확정으로 나옵니다 (천장).' },
  ...
  helpStatSuccessRate: { en: 'Success Rate', ko: '성공률' },
  helpStatSuccessRateDesc: { en: 'The chance a risky enhance succeeds and the card gains a level. Special Enhance raises it.',
                             ko: '위험 강화가 성공해 카드 레벨이 오를 확률입니다. 특수강화를 켜면 올라갑니다.' },
  helpStatDestroy:     { en: 'Destroy Chance', ko: '파괴 확률' },
  helpStatDestroyDesc: { en: 'The chance a failed enhance destroys the card. Only some fails destroy — most just keep the card. Protection with a charge makes it 0%.',
                         ko: '강화 실패 시 카드가 파괴될 확률입니다. 실패해도 일부만 파괴되고 대부분은 카드가 유지됩니다. 보호 충전이 있으면 0%가 됩니다.' },
  helpStatKeep:        { en: 'Kept', ko: '유지' },
  helpStatKeepDesc:    { en: 'A failed enhance often just doesn’t level up — the card is kept, only the attempt cost is spent.',
                         ko: '강화에 실패해도 대개 레벨만 안 오르고 카드는 유지됩니다 — 시도 비용만 소모됩니다.' },
  ...
  hexBonusNone:     { en: 'Hexagon bonus: fill any 3-in-a-row — same family/rarity pays extra',
                      ko: '헥사곤 보너스: 한 줄(3칸)을 채우면 완성 — 같은 계열·등급이면 보너스 ↑' },
  ...
  fuseBatch:        { en: 'Mass Fusion ×{n}', ko: '대규모 융합 ×{n}' },
  ...
  favoriteToggle:   { en: 'Lock — protect from Mass Fusion', ko: '잠금 — 대규모 융합에서 보호' },
  ...
  enhanceReadoutKeep: { en: 'Kept', ko: '유지' },
  enhanceReadoutDestroy: { en: 'Destroy', ko: '파괴' },
  ...
  enhanceOutcomeFail: { en: 'No change', ko: '변화 없음' },
