...
export const STRINGS = {
  ...
  tutAutoIncome:       { en: 'Your universe now makes Matter automatically from the rift (1/sec to start). Keep clicking to collect entities — equip and enhance them to speed it up.',
                         ko: '이제 균열에서 물질이 자동으로 생성됩니다 (기본 초당 1). 계속 클릭해 엔티티를 모으고, 장착·강화하면 더 빨라집니다.' },
