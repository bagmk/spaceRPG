...
export const STRINGS = {
  ...
  shopTutorialHint:   { en: 'Claim your free Quanta Boost to continue.',
                        ko: '무료 퀀타 부스트를 받아 계속 진행하세요.' },
  ...
  shopCosmicSurgeDesc:{ en: 'Quanta x3 for 10 minutes.', ko: '10분 동안 퀀타 x3.' },
  shopAeonSurgeName:  { en: 'Aeon Surge',     ko: '영겁 쇄도' },
  shopAeonSurgeDesc:  { en: 'Time x100 for 30 minutes.', ko: '30분 동안 시간 x100.' },
  shopQuantaStormName:{ en: 'Quanta Storm',   ko: '퀀타 폭풍' },
  shopQuantaStormDesc:{ en: 'Quanta x30 for 30 minutes.', ko: '30분 동안 퀀타 x30.' },
